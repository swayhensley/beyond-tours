...
export default function Hero() {
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden !p-0 !m-0">
      {/* Background with Zoom Animation */}
      <div 
        className="absolute inset-0 bg-cover bg-center transition-transform duration-[10000ms] scale-100 hover:scale-110 !p-0 !m-0"
        style={{
