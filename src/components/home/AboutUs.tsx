        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="relative group order-2 lg:order-1">
            <div className="relative reveal-left">
              ...
              <div className="absolute -bottom-12 -right-12 w-1/2 aspect-square rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white hidden md:block reveal-right transition-transform duration-700 group-hover:-translate-x-4">
                <div 
