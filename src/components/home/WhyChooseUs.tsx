    ...
    <section id="why-choose-us" className="py-24 md:py-32 bg-[#faf9f6] relative overflow-hidden">
      <div className="container-custom">
        <div className="text-center mb-20 space-y-4">
          <span className="text-secondary font-black tracking-[0.2em] uppercase text-sm flex justify-center items-center gap-3 reveal">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {benefits.map((benefit, index) => (
            <div key={index} className="flex flex-col items-center text-center p-10 rounded-[2.5rem] transition-all duration-700 bg-white/80 backdrop-blur-sm shadow-xl shadow-black/5 hover:shadow-secondary/10 group border border-gray-100 hover:border-secondary/20 hover:-translate-y-2 reveal">
